...
宣導品管理頁採分頁操作，分為「配送任務」、「非接種站配送」與「品項管理」。配送任務可修改配送狀態、預計配送數量、廠商名稱與備註，也可將任務狀態改為 `取消`。系統不提供真刪除，修改與取消均會寫入異動紀錄。品項管理目前提供啟用品項檢視與建立或檢查工作表入口，新增或調整品項仍建議於 Google Sheet「宣導品品項表」處理。
