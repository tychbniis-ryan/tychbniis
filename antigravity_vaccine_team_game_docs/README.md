...
目前第 3 版已完成寶箱資料表、關題後寶箱取得判定、每人最多 3 個未開啟寶箱限制、開寶箱 API、道具庫讀取、基本道具效果、幸運獎與全對獎結算、戰隊加權平均分排行榜、學員端浮動寶箱與成就 UI、創作題投稿、隊內初選、講師審核代表作品、匿名全體投票與賽後報表匯出。`0.3.13` 已降低學員端自動 GAS 呼叫、修正創作題倒數閃爍、創作決選第一名戰隊加分、修正紅點顯示條件、戰隊積分無條件進位，並新增講師端結算競賽與學員端最後成績頁。
