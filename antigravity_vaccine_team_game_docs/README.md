...
第 5 版已於 2026-05-28 推進至 `0.5.13` 遊戲確認視窗、寶箱機率與全對獎區塊修正版。

第 5 版定位為「Pixel Art Retro Game UI 教學展示版」。`0.5.13` 主要修正原生確認視窗、寶箱獎勵機率、翻身卡限制與投影端全對獎換行裁切問題。
...
| 快照 | `screenshots/v5_0_5_1/` 至 `screenshots/v5_0_5_13/` |
| 後端狀態 | `0.5.8` 修正翻身卡唯一最後 1 名判定，GAS Web App deployment `@52` |

`0.5.1` 至 `0.5.13` 已完成寶箱、道具、答題回饋、講師端控制流程、投影端排行榜、結算畫面、戰隊識別、挑戰卡抽號碼、成就圖示、PixelArt Icons 套用、獎盃圖資、狀態顯示簡化、UI 文字精簡與手機版 RWD 視覺補強。
