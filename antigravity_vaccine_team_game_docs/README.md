...
目前第 3 版已完成寶箱資料表、關題後寶箱取得判定、每人最多 3 個未開啟寶箱限制、開寶箱 API、道具庫讀取、基本道具效果、幸運獎與全對獎結算、戰隊加權平均分排行榜、學員端寶箱與道具 UI、創作題投稿、隊內初選、講師審核代表作品與匿名全體投票。尚未完成賽後報表匯出。
