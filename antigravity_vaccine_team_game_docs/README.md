...
目前第 3 版已完成寶箱資料表、關題後寶箱取得判定、每人最多 3 個未開啟寶箱限制、開寶箱 API、道具庫讀取、基本道具效果、幸運獎與全對獎結算、戰隊加權平均分排行榜、學員端浮動寶箱與成就 UI、創作題投稿、隊內初選、講師審核代表作品、匿名全體投票與賽後報表匯出。`0.3.10` 已調整加倍卡只能取得或使用 1 次、學員端啟動後才能報到、自由選隊改為啟動前設定且啟動後鎖定、選隊改為方塊按鈕、排行榜改顯示答對率。
