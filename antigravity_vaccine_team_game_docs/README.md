...
目前第 3 版已完成寶箱資料表、關題後寶箱取得判定、每人最多 3 個未開啟寶箱限制、開寶箱 API、道具庫讀取、基本道具效果、幸運獎與全對獎結算、戰隊加權平均分排行榜、學員端浮動寶箱與成就 UI、創作題投稿、隊內初選、講師審核代表作品、匿名全體投票與賽後報表匯出。`0.3.11` 已調整排行榜顯示戰隊人數、整體答對率與當前題目答對率，成就寶箱改為手動領取，挑戰卡使用時才以方塊選擇戰隊，並移除講師端答對率說明區塊。
