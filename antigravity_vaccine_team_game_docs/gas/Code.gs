...
function updateVaccineQuestionBankFromMenu() {
  return updateQuestionBankFromBundledRows(getVaccineQuestionRows(), {
    source: 'Vaccine question bank markdown bundled in GAS',
    message: 'Vaccine question bank upsert completed. No rows were deleted.',
    disableDemoRows: false,
    syncFirebase: true
  });
}
...
function getVaccineQuestionRows() {
  ...
  [
    ...
    "",
    "B",
    "A：** 錯誤。疫苗冷儲黃金溫度必須嚴格維持在 2~8℃ 之間，絕不可低至 0℃。 C：** 錯誤。每日必須「至少兩次」，建議於預注門診開始前、下班前各查核記錄一次。 D：** 錯誤。若低溫常處於 2~3℃，絕對不可擺放不活化疫苗以免發生凍結毀損，該區域應優先放置活性減毒疫苗。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "敘述 1：** 錯誤。千萬別先調溫度！應先拍照錄影存證，並將疫苗移至備用設備後立即通報。 敘述 4：** 錯誤。未經通報自行調溫無法列入「無需賠償」條件，必須是自行發現異常且「主動通報並改善」才符合規定。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "A",
    "敘述 3：** 錯誤。Data Logger 監測頻率應設定在「5 分鐘以內」，才能抓到瞬間的溫度波動。 敘述 4：** 錯誤。6-10 個月是電池的「總壽命」，一旦螢幕出現電池圖示，代表隨時可能沒電，須「立即更換電池」。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A、C：** 錯誤。A 格與 B 格變藍代表溫度曾大於 10℃，需評估暴露時間，但若「D格變藍」才是全數毀損。 D：** 錯誤。HIGH ALARM 僅代表曾大於 8℃，需下載資料評估，不代表立刻全毀。冷凍監視片破裂代表曾低於 0℃，不活化疫苗原則毀損。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "C",
    "A：** 錯誤。千萬別先調溫度，未經通報自行調溫若導致毀損將無法列入「無需賠償」。 B：** 錯誤。需移置保留實體，由衛生局判定是否可用。 D：** 錯誤。首要任務是先保全疫苗移置並通報。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "D",
    "A：** 錯誤。實務上無需每日下載。 B、C：** 錯誤。間隔太久若儀器故障會遺失大量資料，規範建議為每 2 週至 1 個月下載 1 次並存檔備查。 ---",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "A",
    "敘述 2：** 錯誤。水痘、MMR 及日本腦炎 (JE) 等「活性減毒疫苗」不適用提早 4 天寬限期，若提前 5 天(含)以上施打則視同無效須重打。 敘述 4：** 錯誤。一般肌肉注射免疫球蛋白只需間隔 3 個月；接受靜脈注射「高劑量」免疫球蛋白（如川崎氏症治療）才須間隔 11 個月。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A、C：** 錯誤。依規定，若前一劑四合一是在 4歲以後（含）才打，滿 5 歲的 DTaP-IPV 即可免再施打。 D：** 錯誤。疫苗漏打或延遲都不用從頭接種，接續完成未完成的劑次即可。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "C",
    "A：** 錯誤。是打完活性疫苗後才輸血需間隔 2 週。 D：** 錯誤。11 個月是針對靜脈注射「高劑量」免疫球蛋白（如川崎氏症）的規定；一般肌肉注射僅需 3 個月。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "C",
    "A、B：** 錯誤。漏打或延遲的常規疫苗「不用從頭接種」，接續完成即可。 D：** 錯誤。五合一提供基礎保護力，不可隨意跳過。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A：** 錯誤。最新規範指出不宜同時接種以免影響效力。 C：** 錯誤。最少間隔為 28 天。 D：** 錯誤。疫苗絕對不可混合於同一針筒施打。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "1、4：** 屬於不活化疫苗，適用提前 4 天寬限期。 2、3：** 屬於「活性減毒疫苗」，不適用提早 4 天寬限期，若提前 5 天(含)以上打視同無效。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "敘述 1：** 錯誤。政府已有給付處置費，單純打上述公費疫苗時，絕對「不得」再向民眾收取接種診察費（但可收掛號費）。 敘述 4：** 錯誤。地方弱勢補助有「零差額」規定，在補助計畫上限金額內，合約院所不得向民眾收取任何費用，包含差額。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A、C：** 錯誤。流感、新冠、肺炎鏈球菌可同時施打，無間隔限制。 D：** 錯誤。疫苗絕對不可混合施打。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "A",
    "敘述 3：** 錯誤。非高危險群目前無全面公費追加。若擔憂可「自費」追加 1 劑，若陰性再採「0-1-6 個月」時程自費完成。 敘述 4：** 錯誤。育齡婦女接種 MMR 疫苗後的避孕禁忌期為「4 週內」應避免懷孕，並非 2 週。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A：** 錯誤。該項追蹤抽血檢測的檢驗費是由健保給付的。 C：** 錯誤。若抗體陰性且非帶原，政府會「免費追加 1 劑」，1 個月後重驗；若仍陰性，再接續公費完成第 2、3 劑。 D：** 錯誤。公費檢測項目包含 B 肝表面抗原 (HBsAg) 以及表面抗體 (anti-HBs)。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A：** 錯誤。非高危險群目前無全面公費追加。 C：** 錯誤。抗體陰性僅無保護力，不具傳染性。 D：** 錯誤。HBIG 僅限出生 24 小時內之高危險群。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "敘述 2：** 錯誤。必須是自行發現冷鏈異常且「主動通報並改善」，才能列入無需賠償；若被查獲才改善，須負擔原價賠償。 敘述 4：** 錯誤。打錯對象（非計畫對象）或重複接種屬於「原價賠償」等級；冷鏈異常被通知未改善才是 3 倍賠償。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "C",
    "A：** 錯誤。新制起「免向健保署申報」，改由疾管署依 NIIS 系統資料直接核算撥付。 B：** 錯誤。資料上傳期限非常嚴格，務必於當日或隔日中午前上傳，不可拖延累積。 D：** 錯誤。若出現資格不符等異常登錄，超過 4 個月未修正完成，該筆費用直接不予核付，並非 1 年。",
    60,
    "timeBucket",
    false,
    false,
  ...
  [
    ...
    "",
    "B",
    "A：** 錯誤。異常品絕對不可打入人體。 C、D：** 錯誤。需「保留實體單獨冷藏」並清查同批號，由衛生局送交退換貨，不可隨意丟棄。",
    60,
    "timeBucket",
    false,
    false,
