...
export async function requestFastItemUse(data) {
  ...
  const payload = {
    ...
    usedAfterQuestionId: String(data.usedAfterQuestionId || ""),
    usedAfterQuestionSequence: Number(data.usedAfterQuestionSequence || 0),
    settleAtCloseSequence: Number(data.settleAtCloseSequence || 0),
